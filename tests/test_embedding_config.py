...
from sdk.vector._default import create_vector_config, create_qdrant_config, get_embedding_client_config, create_embedding_client
...
class TestEmbeddingConfiguration:
    ...
    def test_bedrock_configuration(self):
        ...
        with patch.dict(os.environ, {
            ...
            assert config['embedder']['config']['aws_secret_access_key'] == 'test_secret'
    ...
    def test_qdrant_fargate_configuration(self):
        ...
        with patch.dict(os.environ, {
            ...
            assert config['url'] == 'http://qdrant-service.namespace.svc.cluster.local:6333'
