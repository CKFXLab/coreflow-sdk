...
from sdk.model.api.openai import OpenAIClient
from sdk.model.api.anthropic import AnthropicClient
...
class TestAnthropicConnection:
    ...
    @patch('sdk.model.api.anthropic.Anthropic')
...
class TestBedrockConnection:
    ...
    def test_bedrock_client_initialization(self, mock_boto_client):
        ...
        try:
            from sdk.model.bedrock.anthropic import BedrockAnthropicClient
