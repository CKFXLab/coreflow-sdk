...
from sdk.vector import RAG, FileOperations, FileInfo, TextChunk
...
class TestRAGContextGeneration:
    ...
    def test_get_context_for_query(self, mock_openai, mock_qdrant):
        ...
        mock_point = Mock()
        mock_point.payload = {"text": "Relevant context document", "source": "knowledge_base"}
...
class TestFileOperations:
    ...
    def test_file_type_detection(self):
        ...
        for filename, expected_type in test_files.items():
            ...
            assert detected_type == expected_type or detected_type == 'text'  # Fallback allowed
...
class TestRAGFileIntegration:
    ...
    def test_file_processing_pipeline(self, mock_openai, mock_qdrant):
        ...
        # Create test file
        content = "This is a test document for RAG processing. " * 50  # Make it long enough to chunk
...
class TestFileProcessingMetadata:
    ...
    def test_comprehensive_metadata_structure(self):
        ...
        expected_metadata_fields = [
            'subject', 'short_description', 'source_file', 'file_path',
            'file_type', 'file_extension', 'file_size_mb', 'file_hash',
            'mime_type', 'processed_date', 'file_created_date', 'file_modified_date',
            'chunk_size', 'overlap', 'chunking_method', 'collection_type',
            'total_content_length', 'word_count', 'line_count'
        ]
    ...
    def test_chunk_metadata_structure(self):
        ...
        expected_chunk_fields = [
            'chunk_id', 'chunk_index', 'chunk_size', 'start_char', 
            'end_char', 'chunk_text_preview'
        ]
