...
def bedrock_config(
    ...
    **kwargs,
    ...
    config.update(
        {"provider": Provider.BEDROCK.value, "model": model, "region_name": region_name}
    )
...
def claude35_sonnet_config(temperature: float = 0.7, **kwargs) -> Dict[str, Any]:
    ...
    return anthropic_config(
        "claude-3-5-sonnet-20241022", temperature=temperature, **kwargs
    )
...
def claude35_haiku_config(temperature: float = 0.7, **kwargs) -> Dict[str, Any]:
    ...
    if model_info:
        return anthropic_config(model_info.model_id, temperature=temperature, **kwargs)
    return anthropic_config(
        "claude-3-5-haiku-20241022", temperature=temperature, **kwargs
    )
...
def claude3_haiku_config(temperature: float = 0.7, **kwargs) -> Dict[str, Any]:
    ...
    if model_info:
        return anthropic_config(model_info.model_id, temperature=temperature, **kwargs)
    return anthropic_config(
        "claude-3-haiku-20240307", temperature=temperature, **kwargs
    )
...
def bedrock_claude4_sonnet_config(
    ...
    return bedrock_config(
        "us.anthropic.claude-sonnet-4-20250514-v1:0", region_name=region_name, **kwargs
    )


def bedrock_claude37_sonnet_config(
    region_name: str = "us-east-1", **kwargs
) -> Dict[str, Any]:
...
def bedrock_claude35_sonnet_v2_config(
    region_name: str = "us-east-1", **kwargs
) -> Dict[str, Any]:
...
def bedrock_claude35_sonnet_config(
    region_name: str = "us-east-1", **kwargs
) -> Dict[str, Any]:
...
def bedrock_claude3_sonnet_config(
    region_name: str = "us-east-1", **kwargs
) -> Dict[str, Any]:
    ...
    return bedrock_config(
        "anthropic.claude-3-sonnet-20240229-v1:0", region_name=region_name, **kwargs
    )


def bedrock_claude3_haiku_config(
    region_name: str = "us-east-1", **kwargs
) -> Dict[str, Any]:
    ...
    if model_info:
        return bedrock_config(model_info.model_id, region_name=region_name, **kwargs)
    return bedrock_config(
        "anthropic.claude-3-haiku-20240307-v1:0", region_name=region_name, **kwargs
    )
