...
class LlamaServerModel(Model):
    ...
    @abstractmethod
    def __init__(self, model_path: str, server_port: int = 8080, 
                 context_length: int = 4096, gpu_layers: int = -1, **kwargs):
        """
    ...
    @abstractmethod
    def _prepare_llamaserver_payload(self, messages: List[Dict[str, str]], **kwargs) -> Dict[str, Any]:
        """
...
class LlamaServerTrainingJob(TrainingJob):
    ...
    @abstractmethod
    def __init__(self, llamaserver_client: LlamaServerModel, model: str, train_data: List[Dict[str, Any]], 
...
class LlamaServerReinforceJob(ReinforceJob):
    ...
    @abstractmethod
    def __init__(self, llamaserver_client: LlamaServerModel, train_kwargs: Dict[str, Any]):
