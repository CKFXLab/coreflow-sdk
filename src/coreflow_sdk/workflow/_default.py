...
def get_credential_aware_workflow_config(env: Optional[ENV] = None) -> Dict[str, Any]:
    ...
    config["enable_websearch"] = config["enable_websearch"] and credentials.get(
...
def get_best_available_model_config(
    ...
    config.update(
        {
            ...
            and config["enable_websearch"],  # Respect credential limitations
